...
docker run -e DB_HOST=host.docker.internal \
  ...
  -p 8081:8081 --name config mod-config:latest
```
...
See project [MODCFG](https://issues.folio.org/browse/MODCFG)
 ...
 * [OpenAPI](src/main/resources/openapi/config.yaml)
 * [Schemas](src/main/resources/openapi/schemas/)

Generated [API documentation](https://dev.folio.org/reference/api/#mod-config).

### Code analysis

[SonarQube analysis](https://sonarcloud.io/dashboard?id=org.folio%3Amod-config).

### Download and configuration

The built artifacts for this module are available.
See [configuration](https://dev.folio.org/download/artifacts) for repository access,
and the Docker images for [released versions](https://hub.docker.com/r/folioorg/mod-config/)
and for [snapshot versions](https://hub.docker.com/r/folioci/mod-config/).
