...
import org.folio.config.server.service.ConfigService;
...
public class MainVerticle extends AbstractVerticle {
  ...
  public void start(Promise<Void> promise) {
    TenantPgPool.setModule("mod-config");
    ModuleVersionReporter m = new ModuleVersionReporter("org.folio/mod-config");
