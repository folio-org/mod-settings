...
* Make getTenantAddresses pageable. [MODSET-42](https://folio-org.atlassian.net/browse/MODSET-42)
* Make address field optional. [MODSET-42](https://folio-org.atlassian.net/browse/MODSET-42)
* Improve tenant address serialization. [MODSET-42](https://folio-org.atlassian.net/browse/MODSET-42)
* Add updatedDate and updatedByUserId to Addresses endpoint. [MODSET-42](https://folio-org.atlassian.net/browse/MODSET-42)
...
* Add GET+PUT /locale API. [MODSET-24](https://folio-org.atlassian.net/browse/MODSET-24)
* Fix parsing of mod-configuration localeSettings. [MODSET-24](https://folio-org.atlassian.net/browse/MODSET-24)
